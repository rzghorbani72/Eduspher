...
export const COUNTRY_LANGUAGE_MAP: Record<string, CountryLanguageMapping> = {
  ...
  TR: { countryCode: 'TR', defaultLanguage: 'tr', supportedLanguages: ['tr', 'en'] }, // Turkey - Turkish
  DE: { countryCode: 'DE', defaultLanguage: 'de', supportedLanguages: ['de', 'en'] }, // Germany - German
  FR: { countryCode: 'FR', defaultLanguage: 'fr', supportedLanguages: ['fr', 'en'] }, // France - French
  ES: { countryCode: 'ES', defaultLanguage: 'es', supportedLanguages: ['es', 'en'] }, // Spain - Spanish
  IT: { countryCode: 'IT', defaultLanguage: 'it', supportedLanguages: ['it', 'en'] }, // Italy - Italian
  RU: { countryCode: 'RU', defaultLanguage: 'ru', supportedLanguages: ['ru', 'en'] }, // Russia - Russian
  CN: { countryCode: 'CN', defaultLanguage: 'zh', supportedLanguages: ['zh', 'en'] }, // China - Chinese
  JP: { countryCode: 'JP', defaultLanguage: 'ja', supportedLanguages: ['ja', 'en'] }, // Japan - Japanese
  KR: { countryCode: 'KR', defaultLanguage: 'ko', supportedLanguages: ['ko', 'en'] }, // South Korea - Korean
  IN: { countryCode: 'IN', defaultLanguage: 'hi', supportedLanguages: ['hi', 'en'] }, // India - Hindi
};
